...
urlpatterns = [
    ...
    # courses
    path('create_course/', login_required(login_url=login_url)(CreateCourseView.as_view()), name='create_course_view'),
    path('manage_courses/', login_required(login_url=login_url)(ManageCoursesView.as_view()), name='manage_courses_view'),
    path('edit_course/<int:course_id>/', login_required(login_url=login_url)(EditCourseView.as_view()), name='edit_course_view'),

    # teachers
    path('manage_teachers/', login_required(login_url=login_url)(ManageTeachersView.as_view()), name='manage_teachers_view'),
    path('create_teachers/', login_required(login_url=login_url)(CreateTeacherView.as_view()), name='create_teacher_view'),
    path('edit_teacher/<int:user_id>/', login_required(login_url=login_url)(EditTeacherView.as_view()), name='edit_teacher_view'),

    # students
    path('manage_students/', login_required(login_url=login_url)(ManageStudentsView.as_view()), name='manage_students_view'),
    path('create_student/', login_required(login_url=login_url)(CreateStudentView.as_view()), name='create_student_view'),
    path('edit_student/<int:user_id>/', login_required(login_url=login_url)(EditStudentView.as_view()), name='edit_student_view'),
